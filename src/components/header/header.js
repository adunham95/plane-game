            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                <div className="flex items-center px-5">
                  ...
                  <div className="ml-3">
                    <div className="text-base font-medium leading-none text-white">{comapnyName}</div>
                    <div className="text-sm font-medium leading-none text-gray-400 pt-1">$10000</div>
                  </div>
                </div>
